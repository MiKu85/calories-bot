...
_WELCOME = (
    "<b>Привет!</b> Я помогу тебе отслеживать калории и макросы.\n\n"
    "Просто опиши еду — текстом, голосом или пришли фото — и я оценю КБЖУ и покажу, "
    "сколько осталось на сегодня.\n\n"
    "<i>Дисклеймер: оценки приблизительны и не заменяют консультацию врача или диетолога.</i>"
)
