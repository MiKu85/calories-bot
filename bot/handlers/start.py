...
_WELCOME = (
    "Привет! Спасибо, что подписался на канал про здоровые привычки @healthy_normal — "
    "ежедневно там публикуется много лайфхаков и информации о питании, сне, тренировках, "
    "долголетии на основе научного подхода.\n\n"
    "Моя задача — сделать всё, чтобы ты смог(ла) комфортно идти к своим целям шаг за шагом.\n\n"
    "Но сначала эти цели нужно правильно поставить. Для этого я задам несколько важных вопросов. "
    "Ответы займут не больше 2 минут и помогут мне создать персональный план питания "
    "под твои параметры и запросы.\n\n"
