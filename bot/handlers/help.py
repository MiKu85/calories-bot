...
/day — дневник по дням: исправить или удалить любой приём
...
<b>Если ошибку заметили позже</b>
Открой /day — там все приёмы за день. Нажми на приём, чтобы исправить,
или 🗑, чтобы удалить. Кнопкой «← предыдущий день» можно вернуться
к прошлым дням и почистить старые записи.
